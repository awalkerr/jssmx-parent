...
<base href="<%=basePath%>">
	...
	<!-- 即时通讯 -->
	<link rel="stylesheet" type="text/css" href="/plugins/instantMsg/ext4/resources/css/ext-all.css">
	<link rel="stylesheet" type="text/css" href="/plugins/instantMsg/css/websocket.css" />
	<script type="text/javascript" src="/plugins/instantMsg/ext4/ext-all-debug.js"></script>
	<script type="text/javascript" src="/plugins/instantMsg/websocket.js"></script>
	<!-- 即时通讯 -->
</head>
	<body class="no-skin">
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div id="loadings" style="display:none; width:100%; position:fixed; z-index:99999999;">
								<div class="commitOpacity" id="pageFrame"></div>
								<div class="loadings">
