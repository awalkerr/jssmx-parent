...
//加载配置文件
//String propertiesPath = request.getSession().getServletContext().getRealPath( currentPath + "env.properties" );
String propertiesPath = request.getRealPath("/plugins/ueditor/jsp/env.properties");
