...
import com.jssmx.common.httpclient.HttpResult;
...
public class ApiService implements BeanFactoryAware {
    ...
    public HttpResult doPost(String url, Map<String,String> params) throws IOException{
        ...
        return closeableHttpResponse(httpPost);
    }
    ...
    private HttpResult closeableHttpResponse(HttpPost httpPost) throws IOException{
        CloseableHttpResponse response = null;
        try {
            // 执行请求
